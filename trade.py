...
from timing import is_k_up_break_ma10, is_k_down_break_ma10
import ccxt

class Trade:
    def __init__(self, cash=1E7, single_position=2E5, 
                begin_date='2021-01-01T16:00:00Z', end_date='2021-12-30T16:00:00Z',
